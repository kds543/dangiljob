	  ...
	  <div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form>
			  <div class="center">
			    <p><span class="fw800 c_blue" id="target_name">OOO</span>님과의 작업이 어땠나요? <span class="c_blue">(필수)</span></p>
    ...
    function SetData(list,target){
    	...
    	$.each(list,function(index , item){
    		var button = "";
    		 ...
    		 button += '<a class="btn btn-outline-primary btn-sm me-1 mb-1" style="margin-bottom:0px;margin-left:5px" href="/view/userdetail/'+item.seq+'">상세정보</a>'
