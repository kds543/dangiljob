			...
			<form>
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-4 col-6 pe-0">
				  <input type="IDnumber" class="form-control" id="regident_reg" placeholder="주민번호 앞 6자리" onKeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength='6'>
				</div>
				<div class="col-sm-5 col-6">
				  <input type="password" class="form-control" id="regident_reg2" placeholder="주민번호 뒤 7자리" onKeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength='7'>
				</div>
			  </div>
			  <div class="row mb-3">
		...
		<div class="form-join">
			...
			<form>
			  <div class="row mb-5">				
				...
				<div class="mb-3 mt-4">
				    <label for="formFile" class="form-label mb-2 fz14"><span class="fw800 me-1 fz14">구직회원</span> 건설기초안전교육 수료증을 등록하세요</label>					
					<input class="form-control form-control-sm" type="file" accept="image/png, image/jpeg" id="img1_b" onchange="loadFileBack(this,'#img1')">					
				</div>

				<div class="mb-3 mt-4">
				    <label for="formFile" class="form-label mb-2 fz14"><span class="fw800 me-1 fz14">구직회원</span> 신분증 <span class="fz12 c-blue">(뒷자리 6자리 가리고 등록하세요)</span></label>
