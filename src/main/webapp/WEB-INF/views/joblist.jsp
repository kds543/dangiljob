...
<!-- 
 ...
 -->
				...
				<div class="itemList" id="joblist" style="max-height: 2548px;overflow: hidden;">
				</div>
			</div><!--//tabContent-->

			<div class="btnbox">
				<a href="javascript:;" class="btnCommonStyle1" style="display:none">
					<img src="/resources/djver/images/icon_list.png" alt="list">
					<span>건설인력 일자리 더보기</span>
				</a>
				<a href="/map" class="btnCommonStyle1" style="width:99%;margin-left:1%">
...
<div class="footerbar">
	<div class="maxWrap">
		...
		<div class="right">
			<a href="javascript:;">
				<img src="/resources/djver/images/icon_insta.png" alt="인스타그램">
			</a>
			<a href="javascript:;">
				<img src="/resources/djver/images/icon_facebook.png" alt="페이스북">
			</a>
			<a href="javascript:;">
				<img src="/resources/djver/images/icon_youtube.png" alt="유투브">
			</a>
		</div>
	</div>
</div>
