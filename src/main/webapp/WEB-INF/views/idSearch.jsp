	...
	$(function(){
	   ...
	   <div class="login">
			<div class="form-signin  text-center">
			  ...
			  <form>
				<h1 class="mb-5 mt-2">아이디 찾기</h1>
				<div class="form-floating">
				  <input type="name" class="form-control" id="name_txt" placeholder="name">
				...
				<p class="mt-3 mb-3 text-muted">회원 아이디와 변경된 비밀번호가 이메일로 전송됩니다.</p>
				
				<button class="w-100 btn btn-lg btn-primary" type="button" onclick="idSearch()">아이디 찾기</button>
			  </form>
...
function idSearch(){
	Kajax("/action/idSearch",{
		name : $("#name_txt").val()
		,email : $("#email_txt").val()
	},function(res){
		if(res.success){
			Ktoast({
				text : "해당 이메일로 아이디를 발송하였습니다."
				,type : 2
			})
		}else{
			Ktoast({
