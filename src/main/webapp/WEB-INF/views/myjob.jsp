      ...
      <div class="row" >
        ...
        <div class="col-lg-9 col-12 mx-auto">
          <div class="card card-body mt-4">
            <h6 class="mb-0">구직정보</h6>
            <p class="text-sm mb-0">구직정보를 입력해주세요</p>
            <hr class="horizontal dark my-3">
            <label for="projectName" class="form-label">구직타이틀</label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="form-check form-switch ms-1">
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" onclick="notify(this)" data-type="warning" data-content="구직중으로 선택될경우 메인화면에 노출됩니다." data-title="Warning" data-icon="ni ni-bell-55">
            ...
            <select class="form-control" name="choices-multiple-remove-button" id="choices-multiple-remove-button" multiple>
             ...
             -->
              <div class="row">
	              <div class="col-6">
	                <label class="form-label">지원금액(월급 또는 일급)</label>
	                <input class="form-control" type="text" id="pay" onkeyup="numberWithCommastext(this , false)">
	              </div>
	              <div class="col-6">
		                <label class="form-label">정규/비정규</label>
    ...
    $(document).ready(function() {
      ...
      function saveData(){
    	  ...
    	  Kajax("/action/updateMyjob",{
    		  ...
    		  ,rec_worker : $("#worker option:selected").val()
    		  ,user_seq : <%=String.valueOf(request.getAttribute("user_seq"))%>
    	  },function(res){
    		  if(res.success){
    			  Kalert("저장이 완료되었습니다.");
