				  ...
				  <div class="modal-dialog modal-lg" style="width:80%;min-width:360px">
				              <div class="modal-content" style="display:block;">
				                         <div class="modal-header">
	                                          <button type="button" class="close" style="border: 0px;border-radius: 15px;background-color: white;" onclick="$('#locationPop').modal('hide')"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
