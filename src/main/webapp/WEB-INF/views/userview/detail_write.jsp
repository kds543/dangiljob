		...
		<div class="detail_write">
			...
			<form onsubmit="return false">
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-10">
				   <input type="name" class="form-control" id="rec_name" placeholder="작성자명을 입력해주세요">
				</div>
			  </div>
			  ...
			  <div class="row mb-3">
				<label for="inputname" class="col-sm-2 col-form-label">지원업무분야</label>
				<div class="col-sm-10">
				   <input type="name" class="form-control" id="rec_detail_job" placeholder="상세한 업무분야를 입력해주세요 또는 선택?">
				</div>
			  </div>
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-10">
				   <input type="name" class="form-control" id="rec_pay" placeholder="지급액을 입력해주세요">
				</div>
			  </div>
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-10">
				   <input type="name" class="form-control" id="rec_date_time" placeholder="총 업무시간을 입력해주세요">
				</div>
			  </div>
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-10">
				   <input type="name" class="form-control" id="rec_phone_number" placeholder="연락처를 입력해주세요">
				</div>
			  </div>
		...
		function load(){
			Kajax("/action/getMyinfo",{
				...
				if(res.success){
				    ...
				    $('input:radio[name=rec_contry]:input[value=' + res.rows.rec_gender + ']').attr("checked", true);
