	                ...
	                <div class="panel panel-primary">
	                    <div class="panel-heading">
	                        ...
	                        <div class="ibox-tools" style="top:10px;right:30px">
	                        	<button class="btn btn-default" style="color:gray" onclick="pageLengChange()" id="cnt_100_btn">  100</button>
	                        	<button class="btn btn-success" onclick="javascript:location.href='/view/newNotice'">  공지사항등록</button>
                       	 	</div>
	                    </div>
	                    ...
	                    <div class="row">
	                       <table class="table table-striped table-hover datatable-cls" style="border-collapse:collapse !important;width:100%;text-align: center"  id="datatable" style="width:100%;" >
				                    <thead>
				                    <tr>
				                    	<th style='min-width:80px;width:80px' >등록일</th>
				                    	<th style='min-width:80px;width:60px' >제목</th>
				                    	<th style='min-width:80px;width:60px' >알림여부</th>
				                        <th style='min-width:60px;max-width:60px;width:60px'><center><input type="checkbox" onclick="checkboxall()" id="checkboxall1_btn" /> </center></th>
				                    </tr>
				                    </thead>
				                    <tbody>
				                    </tbody>
				        ...
				        <div class="row">
				              <button style="position: absolute; bottom: 30px; right:30px" class="btn btn-primary" onclick="noticeDel()">공지사항삭제</button>
				        </div>
	                    </div>
	                </div>
           		</div>
...
$(document).ready(function() {
        ...
        "columnDefs": [
        	{
                ...
                'render': function (data, type, full, meta){
                	return '<center><input type="checkbox" style="margin-left:20px" name="datatablecheckbox" value="'+data+'"></center>';
                }
            }
		],
		language : lang_kor,
    ...
    $('#datatable tbody').on('click', 'td', function () {
		if(datatables.cell(this).index().columnVisible != 4){
			location.href = "/view/notice_detail/"+datatables.row( this ).data()[4];
			return;
		}
